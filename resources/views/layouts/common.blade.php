                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="widget widget-instagram">
                            ...
                            <figure class="widget-body row">
                                <div class="col-3">
                                    <img src="/cassets/images/instagram/01.jpg" alt="instagram 1" width="64"
                                         height="64"/>
                                </div>
                                <div class="col-3">
                                    <img src="/cassets/images/instagram/02.jpg" alt="instagram 2" width="64"
                                         height="64"/>
                                </div>
                                <div class="col-3">
                                    <img src="/cassets/images/instagram/03.jpg" alt="instagram 3" width="64"
                                         height="64"/>
                                </div>
                                <div class="col-3">
                                    <img src="/cassets/images/instagram/04.jpg" alt="instagram 4" width="64"
                                         height="64"/>
                                </div>
                                <div class="col-3">
                                    <img src="/cassets/images/instagram/05.jpg" alt="instagram 5" width="64"
                                         height="64"/>
                                </div>
                                <div class="col-3">
                                    <img src="/cassets/images/instagram/06.jpg" alt="instagram 6" width="64"
                                         height="64"/>
                                </div>
                                <div class="col-3">
                                    <img src="/cassets/images/instagram/07.jpg" alt="instagram 7" width="64"
                                         height="64"/>
                                </div>
                                <div class="col-3">
                                    <img src="/cassets/images/instagram/08.jpg" alt="instagram 8" width="64"
                                         height="64"/>
                                </div>
                            </figure>
                        </div>
...
<script src="/cassets/vendor/parallax/parallax.min.js"></script>
